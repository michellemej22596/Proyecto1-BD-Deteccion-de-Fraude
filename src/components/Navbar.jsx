  ...
  return (
    <nav className={show ? 'sidenav active' : 'sidenav'}>
      ...
      <ul>
        ...
        <li><a href="/create"><IoMdCreate /> Create</a></li>
        <li><a href="/read"><IoReaderSharp /> Read</a></li>
        <li><a href="/update"><GrUpdate /> Update</a></li>
        <li><a href="/delete"><MdDelete /> Delete</a></li>
      </ul>
    </nav>
  );
};
