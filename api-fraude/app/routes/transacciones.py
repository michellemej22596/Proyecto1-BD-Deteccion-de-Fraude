...
from app.services.transaccion_service import (
    obtener_transacciones_service, obtener_transacciones_serviceT, agregar_transaccion_service, buscar_transacciones_por_tipo_service
)
...
@router.get("/searchClientID/{cliente_id}")
def obtener_transacciones(cliente_id: int):
    return obtener_transacciones_service(cliente_id)

@router.get("/searchTransactionID/{transaccion_id}")
def obtener_transaccionesT(transaccion_id: int):
    return obtener_transacciones_serviceT(transaccion_id)
